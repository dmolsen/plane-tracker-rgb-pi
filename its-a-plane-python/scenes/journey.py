...
# extrasmall baseline is y=16 now; clear a safe band around it
DIST_CLEAR = (
    DISTANCE_POSITION[0],
    DISTANCE_POSITION[1] - 5,     # 11
    DISTANCE_POSITION[0] + DISTANCE_WIDTH,
    DISTANCE_POSITION[1],     # exclusive -> clears up to row 15
)
